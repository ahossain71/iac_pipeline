  ...
  stages {
    stage('Submit Stack') { 
      steps {
        ...
        sh "aws cloudformation deploy --template-file  '$workspace/cloudformation/sunday_web_stack.template' --stack-name sundayWebStack --region 'us-east-1' --parameter-overrides InstanceType=t2.micro KeyName='s3://cf-templates-a1jqt245fpux-us-east-1/DevOpsKeyPair.pem' SSHLocation=0.0.0.0/0"
      }
    }
  }
}